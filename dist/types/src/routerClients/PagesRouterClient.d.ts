...
export default class PagesRouterClient extends RouterClient {
     ...
     */
    constructor(req: import('next').NextApiRequest, res: import('next').NextApiResponse, options: {
        onError?: () => void;
        config: {
    ...
    kindeClient: {
        ...
        getIntegerFlag: (sessionManager: import('@kinde-oss/kinde-typescript-sdk').SessionManager, code: string, defaultValue? /**
         *
         * @param {string} url
         * @returns
     ...
     * @returns
     */
    redirect(url: string): import('next').NextApiResponse<any>;
}
