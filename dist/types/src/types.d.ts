import { ClaimTokenType, CreateOrgURLOptions, FlagType, GetFlagType, LoginURLOptions, RegisterURLOptions, SessionManager, UserType } from '@kinde-oss/kinde-typescript-sdk';
export type KindeProperty = {
    t: "b" | "s" | "i";
    value: unknown;
};
...
export type KindeClient = {
    ...
    getOrganization: (sessionManager: SessionManager) => Promise<KindeOrganization>;
    ...
    getClaimValue: (sessionManager: SessionManager, claim: string, type?: ClaimTokenType) => Promise<unknown>;
    ...
    getFlag: (sessionManager: SessionManager, code: string, defaultValue?: string | number | boolean | undefined, type?: keyof FlagType | undefined) => Promise<GetFlagType>;
...
export type KindeState = {
    ...
    getBooleanFlag: (code: string, defaultValue: boolean) => boolean | null | undefined;
    getClaim: (claim: string, tokenKey?: "access_token" | "id_token") => {
        name: string;
        value: string;
    } | null;
    getFlag: (code: string, defaultValue: string | number | boolean, flagType: KindeFlagTypeCode) => KindeFlag | null;
    getIdToken: () => KindeIdToken | null;
    getIntegerFlag: (code: string, defaultValue: number) => number | null | undefined;
    ...
    getStringFlag: (code: string, defaultValue: string) => string | null | undefined;
